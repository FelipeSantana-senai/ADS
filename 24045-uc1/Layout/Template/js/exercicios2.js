...
$("input[data-exercicio1]").click(function () {
    switch ($(this).data("exercicio1")) {
        ...
        case 1:
            ...
            } else if (tentativasEx1 == 0 && ($(this).data("alternativa1") != "c")) {
            ...
            } else if (tentativasEx1 == 1 && ($(this).data("alternativa1") != "c")) {//Letra correspondente a alternativa
